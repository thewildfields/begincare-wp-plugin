/******/ (() => { // webpackBootstrap
/*!*****************************************!*\
  !*** ./blocks/providers-search/view.js ***!
  \*****************************************/
...
async function initAutocomplete() {
  ...
  const onPlaceChanged = () => {
    ...
    const state = place.address_components.filter(x => {
...
const goToResultsPage = e => {
  ...
  if (Object.hasOwn(searchQuery, 'service') && Object.hasOwn(searchQuery, 'serviceId') && Object.hasOwn(searchQuery, 'lat') && Object.hasOwn(searchQuery, 'lng') && Object.hasOwn(searchQuery, 'location') && Object.hasOwn(searchQuery, 'state')) {
